...
public class GoldJewelleryDisplay {
	...
	public static void main(String[] args) {
		GoldJewelleryEntity entity = new GoldJewelleryEntity(1,JewelleryType.BRACELETT, 50000.00, 9000.00, 10.0, 2000.00,
				1000.00, true, "Kalyan jewellery");
		GoldJewelleryEntity entity1 = new GoldJewelleryEntity(2,JewelleryType.EARRINGS, 50000.00, 9000.00, 10.0, 3000.00,
				5000.00, true, "Malabar");
		GoldJewelleryEntity entity2 = new GoldJewelleryEntity(3,JewelleryType.NECKLESS, 50000.00, 9000.00, 10.0, 4000.00,
				3000.00, true, "Joyalukas");
		GoldJewelleryEntity entity3 = new GoldJewelleryEntity(4,JewelleryType.RING, 50000.00, 9000.00, 10.0, 5000.00,
				2000.00, true, "Lalitha gold");
		GoldJewelleryEntity entity4 = new GoldJewelleryEntity(5,JewelleryType.BRACELETT, 50000.00, 9000.00, 10.0, 2000.00,
